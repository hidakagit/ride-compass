...
interface SafetyRecipePanelProps {
  ...
  /** 参照表示用（読み取り専用）。CarStressRecipePanelと同じ扱い。 */
...
// （街灯・トンネル補正だけでは段階を持たない）、CAR_STRESS_COLORSを流用する
...
// 研究モードでの安全度レシピ上書きUI（改善計画: 安全度レシピ）。CarStressRecipePanel.tsxと
