...
// value/onChange/ariaLabelという既存props自体が元々「向きだけ」を扱う汎用的な形の
// ため、page.tsxが風・勾配それぞれ独立したstate（windBearingDeg/gradientBearingDeg）で
// 本コンポーネントを2箇所マウントするだけで「向きのみのモード」の要件を満たす。
//
