...
- [ ] [T1069](records/tasks/T1069.md). 地図の上に開くポップオーバーから始めたピンチが、ページを拡大するかを確かめる 規模S — トリガー: [T1078](records/tasks/T1078.md)の完了（規則は実施済み、E2Eでの確認が残る）
...
- [ ] [T1079](records/tasks/T1079.md). ページのピンチを止める規則を、E2Eの全状態の走査で確かめる（T1069の残り、T1078の後） 規模S
