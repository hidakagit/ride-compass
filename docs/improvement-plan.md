...
### - [ ] T5. `api/routes.py` のルータ分割＋レート制限値のSettings化〔D1〕規模M
...
### - [ ] T6. Repositoryの責務分割＋トランザクション境界の規約化〔C1/C2〕規模L
...
### - [ ] T8. architecture.md の「現状」と「経緯」分離〔D3〕規模M
