...
## 対応状況
- F-1〜F-3: ユーザー承認を得て2026-08-19に全件対応済み。F-1は
  `recipeExpression.ts`のコメント修正、F-2は`test_registry_defaults.py`へ
  `_AXIS_DIFFICULTY_FIELD_TO_AXIS_ID`版の突き合わせテストを追加、F-3は
  `2026-08-19_all.md`の対応状況欄を実施完了の内容へ更新（history/README.mdが許可する更新）。
