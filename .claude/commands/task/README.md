...
├── _history.md # （未作成）task基盤自体の運用ルールの経緯・根拠を置く想定の置き場所。
│               # review基盤の_history.mdと対になる構成だが、task基盤側はまだ経緯を
│               # 書き足すほどの変更履歴が無いため未作成——retro.mdが提案先の1つとして
│               # 参照しており、初めて経緯を記録する必要が生じた時点でretro.mdが新設を
│               # 提案する（改善計画T454、2026-08-31）
